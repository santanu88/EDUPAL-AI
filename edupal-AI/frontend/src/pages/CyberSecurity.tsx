...
import cyberSecurityImage from "../assets/img8.png"; // Assuming this is a cybersecurity-themed image
    ...
    <div className="flex flex-col h-screen bg-black">
      ...
      <div className="p-4 border-b border-zinc-800">
        <div className="max-w-5xl mx-auto flex items-center">
          ...
          <h1 className="text-white font-medium">Cyber Security Expert Chat</h1>
        </div>
      </div>
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-[70vh] text-center animate-fade-in">
              ...
              <p className="text-zinc-400 max-w-md">
                Ask me about Network Security (Firewalls, IDS/IPS, VPNs),
                Malware Analysis (Viruses, Worms, Trojans, Ransomware),
                Penetration Testing, Cryptography, and more
              </p>
            </div>
          ) : (
      ...
      <div className="border-t border-zinc-800 bg-black p-4">
        ...
        >
          <Input
            ...
            placeholder="Ask about network security, malware analysis, ethical hacking..."
