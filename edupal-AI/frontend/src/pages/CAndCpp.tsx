...
import cppImage from "../assets/cn5.jpg";
    ...
    <div className="flex flex-col h-screen bg-black">
      ...
      <div className="p-4 border-b border-zinc-800">
        <div className="max-w-5xl mx-auto flex items-center">
          ...
          <h1 className="text-white font-medium">C and C++ Expert Chat</h1>
        </div>
      </div>
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-[70vh] text-center animate-fade-in">
              ...
              <p className="text-zinc-400 max-w-md">
                Ask me about C/C++ programming, memory management, pointers,
                data structures, algorithms, performance optimization, low-level
                      ...
                      {message.role === "assistant" && (
                        <div className="mt-2 pt-2 border-t border-zinc-800 text-xs text-zinc-400 opacity-70">
                          <div className="flex items-center">
                            ...
                            <span>Specialized in C and C++ Programming</span>
                          </div>
                        </div>
                      )}
                    </>
      ...
      <div className="border-t border-zinc-800 bg-black p-4">
        ...
        >
          <Input
            ...
            placeholder="Ask about pointers, memory management, STL, performance optimization..."
