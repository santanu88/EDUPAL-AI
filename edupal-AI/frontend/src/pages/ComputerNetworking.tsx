...
import cnImage from "../assets/cn1.jpg";
interface Message {
  id: string;
  role: "user" | "assistant";
  content: string;
...
export default function ComputerNetworking() {
  const [messages, setMessages] = useState<Message[]>([]);
  const [input, setInput] = useState("");
  const [isLoading, setIsLoading] = useState(false);
  const messagesEndRef = useRef<HTMLDivElement>(null);
  const chatContainerRef = useRef<HTMLDivElement>(null);
  const subjectExpert = "computer networking";
    ...
    <div className="flex flex-col h-screen bg-black">
      ...
      <div className="p-4 border-b border-zinc-800">
        <div className="max-w-5xl mx-auto flex items-center">
          ...
          <h1 className="text-white font-medium">Networking Expert Chat</h1>
        </div>
      </div>
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-[70vh] text-center animate-fade-in">
              ...
              <p className="text-zinc-400 max-w-md">
                Ask me about TCP/IP, routing protocols, network security, 
                cloud networking, or any networking concepts.
              </p>
            </div>
          ) : (
                    ...
                    {message.role === "assistant" && (
                      <div className="mt-2 pt-2 border-t border-zinc-800 text-xs text-zinc-400 opacity-70">
                        <div className="flex items-center">
                          ...
                          <span>Specialized in Computer Networking</span>
                        </div>
                      </div>
                    )}
                  </div>
      ...
      <div className="border-t border-zinc-800 bg-black p-4">
        ...
        >
          <Input
            ...
            placeholder="Ask about TCP/IP, routing protocols, network security, cloud networking..."
