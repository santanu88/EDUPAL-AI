...
import cloudImage from "../assets/pic2.png"; // Make sure to add your cloud computing image
    ...
    <div className="flex flex-col h-screen bg-black">
      ...
      <div className="p-4 border-b border-zinc-800">
        <div className="max-w-5xl mx-auto flex items-center">
          ...
          <h1 className="text-white font-medium">Cloud Computing Expert Chat</h1>
        </div>
      </div>
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-[70vh] text-center animate-fade-in">
              ...
              <p className="text-zinc-400 max-w-md">
                Ask me about AWS, Azure, GCP, serverless computing, containers, 
                cloud security, IaC, DevOps in cloud, or any cloud computing concepts
              </p>
            </div>
          ) : (
      ...
      <div className="border-t border-zinc-800 bg-black p-4">
        ...
        >
          <Input
            ...
            placeholder="Ask about AWS, Azure, Kubernetes, serverless, cloud security..."
