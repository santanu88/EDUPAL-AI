...
import dataScienceImage from "../assets/pic1.png"; // Update with your image path
...
export default function DataScienceExpert() {
      ...
      <div className="p-4 border-b border-zinc-800">
        <div className="max-w-5xl mx-auto flex items-center">
          ...
          <h1 className="text-white font-medium">
            Data Science & Engineering Expert Chat
          </h1>
        </div>
      </div>
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-[70vh] text-center animate-fade-in">
              ...
              <h1 className="text-2xl font-bold text-white mb-2">
                Data Science & Engineering Expert
              </h1>
              <p className="text-zinc-400 max-w-md">
                Ask me about machine learning, data pipelines, ETL processes,
                statistical analysis, big data technologies, data visualization,
                or any data-related concepts
              </p>
            </div>
          ) : (
      ...
      <div className="border-t border-zinc-800 bg-black p-4">
        ...
        >
          <Input
            ...
            placeholder="Ask about Python, SQL, Pandas, Spark, ML models, data pipelines..."
