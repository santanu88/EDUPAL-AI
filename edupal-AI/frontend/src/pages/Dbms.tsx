...
import dbmsImage from "../assets/cn3.jpg";
interface Message {
  id: string;
  role: "user" | "assistant";
  content: string;
...
export default function Dbms() {
  ...
  const subjectExpert = "database management systems";
    ...
    <div className="flex flex-col h-screen bg-black">
      ...
      <div className="p-4 border-b border-zinc-800">
        <div className="max-w-5xl mx-auto flex items-center">
          ...
          <h1 className="text-white font-medium">DBMS Expert Chat</h1>
        </div>
      </div>
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-[70vh] text-center animate-fade-in">
              ...
              <p className="text-zinc-400 max-w-md">
                Ask me about SQL queries, normalization, indexing, transactions,
                ACID properties, NoSQL databases, or any DBMS concepts.
              </p>
            </div>
          ) : (
      ...
      <div className="border-t border-zinc-800 bg-black p-4">
        ...
        >
          <Input
            ...
            placeholder="Ask about SQL queries, normalization, transactions, NoSQL..."
