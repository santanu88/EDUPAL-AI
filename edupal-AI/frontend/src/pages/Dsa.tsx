...
import dsaImage from "../assets/img7.png";
...
export default function Dsa() {
  ...
  const subjectExpert = "data structures and algorithms";
    ...
    <div className="flex flex-col h-screen bg-black">
      ...
      <div className="p-4 border-b border-zinc-800">
        <div className="max-w-5xl mx-auto flex items-center">
          ...
          <h1 className="text-white font-medium">DSA Expert Chat</h1>
        </div>
      </div>
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-[70vh] text-center animate-fade-in">
              ...
              <p className="text-zinc-400 max-w-md">
                Ask me about arrays, trees, graphs, sorting algorithms, time complexity, 
                or any DSA concepts. I can help with Leetcode problems too!
              </p>
            </div>
          ) : (
      ...
      <div className="border-t border-zinc-800 bg-black p-4">
        ...
        >
          <Input
            ...
            placeholder="Ask about arrays, trees, graphs, sorting algorithms, time complexity..."
